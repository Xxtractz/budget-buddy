    ...
    return (
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <h2 className="text-xl lg:text-2xl font-bold">Budget Categories</h2>
          <Button 
        ...
        <Card className="shadow-sm">
          <CardContent className="p-8 lg:p-12 text-center">
            <div className="text-muted-foreground">
              ...
              <p className="mb-4 text-sm lg:text-base">Create budget categories to track your spending limits.</p>
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {budgets.map((budget) => {
          ...
          return (
            <Card key={budget.id} className="hover:shadow-md transition-shadow shadow-sm">
              <CardHeader className="pb-3">
                <div className="flex justify-between items-start gap-3">
                  ...
                  <Button
                    ...
                    className="h-10 w-10 p-0 hover:bg-destructive/10 hover:text-destructive flex-shrink-0"
                  >
